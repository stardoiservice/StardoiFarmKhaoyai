...
const translations = {
  ...
  'info-2-desc': { th: 'ผู้ใหญ่ | เด็ก : 120 บาท | เด็ก (สูงไม่เกิน 120 ซม.): 0 บาท (ฟรี)', en: 'Adult | Child: 120 THB | Child (under 120cm): FREE', zh: '成人 | 儿童：120泰铢 | 儿童（120厘米以下）：免费', ja: '大人 | 子供：120バーツ | 子供（身長120cm以下）：無料' },
