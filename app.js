...
const translations = {
  ...
  'hero-cta': { th: 'สำรองบัตรเข้าชม', en: 'Book Ticket Now', zh: '立即订票', ja: 'チケットを予約する' },
  'hero-secondary-cta': { th: 'สำรวจกิจกรรม', en: 'Explore Activities', zh: '探索活动', ja: 'アクティビティを見る' },
  ...
  'feat-scenery-title': { th: 'วิวทิวทัศน์พาโนรามา 360 องศา', en: '360° Mountain View', zh: '360° 山景', ja: '360° のマウンテンビュー' },
  'feat-scenery-desc': { th: 'ทัศนียภาพงดงามดั่งภาพวาดสไตล์ยุโรปในทุกมุมมอง', en: 'Photos look like Switzerland from every angle', zh: '从任何角度拍照都像在瑞士一样美', ja: 'どこから写真を撮ってもスイスのような美しさ' },
  'feat-organic-title': { th: 'อาหารสัตว์เกรดพรีเมียม', en: 'Premium Feeding', zh: '优质饲料', ja: 'プレミアムなエサやり' },
  'feat-organic-desc': { th: 'หญ้าและพืชผักออร์แกนิก ปลอดภัยต่อเด็กและสัตว์เลี้ยง', en: 'Organic grass and vegetables, safe for kids & sheep', zh: '有机牧草和蔬菜，对孩子和羊群都很安全', ja: '子供と羊に安全なオーガニック牧草と野菜' },

  // Flock Section
  'flock-tag': { th: 'ดาวเด่นประจำฟาร์ม', en: 'Farm Stars', zh: '农场之星', ja: '牧場のスターたち' },
  'flock-title': { th: 'ทำความรู้จักน้องแกะตัวโปรด', en: 'Meet Our Fluffy Flock', zh: '认识我们毛茸茸的羊群', ja: 'ふわふわの羊たちに会いましょう' },
  'flock-card-mumu-tag': { th: 'สายกินจุ', en: 'Merino Wool', zh: '美利奴羊毛', ja: 'メリノウール' },
  'flock-card-mumu-name': { th: 'น้องมูมู่ (Mumu)', en: 'Mumu', zh: '木木 (Mumu)', ja: 'ムム (Mumu)' },
  'flock-card-mumu-desc': { th: 'แกะเมอริโนขนปุยหนานุ่มฟูที่สุดในฟาร์ม อ่อนโยนและน่ารัก...', en: 'The fluffiest Merino sheep in the farm. Extremely gentle and cute...', zh: '农场里毛最蓬松的美利奴羊。极其温顺可爱...', ja: '牧場で最もふわふわなメリノ羊。とても穏やかで可愛い...' },
  ...
  'flock-card-coco-desc': { th: 'แกะขนสีน้ำตาลช็อกโกแลตสุดหล่อที่รู้มุมกล้อง โพสท่าเก่งสุดๆ...', en: 'Our chocolate-brown photogenic star who strikes a pose instantly...', zh: '我们上镜的巧克力棕色明星，随时准备摆姿势...', ja: 'すぐにポーズをとる、写真映えするチョコレートブラウンのスター...' },
  ...
  'act-1-title': { th: 'ใกล้ชิดกับน้องแกะ', en: 'Close Feeding Session', zh: '近距离喂食体验', ja: '間近でのエサやり体験' },
  ...
  'act-2-title': { th: 'ล่องคายัค ณ ลำธารน้ำผุด', en: 'Kayaking in Natural Springs', zh: '天然泉水皮划艇', ja: '天然泉でのカヤック' },
  'act-2-desc': { th: 'ล่องเรือคายัคสัมผัสความสดชื่นในลำธารน้ำผุดธรรมชาติที่ใสสะอาด ท่ามกลางร่มเงาไม้ใหญ่ เหมาะสำหรับการพักผ่อนของทุกเพศทุกวัย', en: 'Relax and kayak in the crystal-clear natural spring stream surrounded by lush trees. Fun and safe for everyone.', zh: '在绿树成荫、清澈见底的天然泉水溪流中放松划皮划艇。安全又有趣，适合所有人。', ja: '緑豊かな木々に囲まれた透き通った天然泉の小川でリラックスしてカヤック。安全で誰でも楽しめます。' },
  'act-alpaca-title': { th: 'ทักทายครอบครัวอัลปาก้า', en: 'Alpaca Feeding', zh: '喂食羊驼', ja: 'アルパカのエサやり' },
  'act-alpaca-desc': { th: 'เพลิดเพลินกับความร่าเริงของฝูงอัลปาก้าขนฟูนุ่มแสนรู้ คุณสามารถป้อนอาหารจากมือและถ่ายภาพร่วมกับน้องๆ ได้อย่างใกล้ชิด', en: 'Meet our adorable long-necked, fluffy alpacas. Hand-feed them and take selfies with these smiling, smart creatures.', zh: '遇见我们可爱的长脖子毛绒羊驼。亲手喂食，并与这些爱笑、聪明的动物自拍。', ja: '長首でふわふわの可愛いアルパカに会いましょう。手からエサをあげて、笑顔の賢い動物たちと自撮りしましょう。' },
  'act-rabbit-title': { th: 'เยี่ยมเยือนบ้านกระต่ายน้อย', en: 'Rabbit Feeding', zh: '喂食兔子', ja: 'ウサギのエサやり' },
  'act-rabbit-desc': { th: 'มุมโปรดของคุณหนูๆ กับบ้านกระต่ายดีไซน์สุดคิวท์ ร่วมป้อนแครอทและสัมผัสความน่ารักของกระต่ายหลากหลายสายพันธุ์', en: 'A treat for kids with our cute rabbit house. Feed carrots and pet various breeds of joyful, hopping bunnies.', zh: '在可爱的兔子屋里给孩子们带来惊喜。喂胡萝卜并抚摸各种欢蹦乱跳的兔子。', ja: '可愛いウサギ小屋は子供たちに大人気。色々な種類の元気なウサギにニンジンをあげて撫でましょう。' },
  'act-horse-title': { th: 'ขี่ม้าชมทัศนียภาพ', en: 'Scenic Horseback Riding', zh: '观景骑马', ja: '絶景乗馬' },
  'act-horse-desc': { th: 'บริการขี่ม้าชมบรรยากาศทุ่งหญ้า พร้อมเจ้าหน้าที่ดูแลอย่างใกล้ชิด ให้ผู้เริ่มต้นและเด็กๆ ได้สัมผัสประสบการณ์แบบคาวบอยอย่างปลอดภัย', en: 'Horseback riding service for photos and scenic views. Guided by staff, it’s perfect for beginners. Feel like a real cowboy!', zh: '提供骑马拍照和观赏美景的服务。由工作人员牵引，非常适合初学者。感觉就像个真正的牛仔！', ja: '写真撮影や絶景を楽しむ乗馬サービス。スタッフが案内するので初心者でも安心です。本物のカウボーイの気分を！' },
  'act-carousel-title': { th: 'ม้าหมุนสุดคลาสสิก', en: 'Classic Carousel', zh: '经典旋转木马', ja: 'クラシックメリーゴーランド' },
  'act-carousel-desc': { th: 'เติมเต็มจินตนาการดั่งสวนสนุกในยุโรป นั่งม้าหมุนวินเทจพร้อมถ่ายภาพความประทับใจร่วมกับครอบครัวท่ามกลางวิวขุนเขา', en: 'Feel like you are in a European amusement park amidst the mountains. Ride the classic carousel and take chic photos with the whole family.', zh: '仿佛置身于群山环抱的欧洲游乐园。乘坐经典的旋转木马，与全家人一起拍下别致的照片。', ja: '山々に囲まれたヨーロッパの遊園地にいるような気分に。クラシックなメリーゴーランドに乗って、家族みんなで素敵な写真を撮りましょう。' },
  'act-paint-title': { th: 'เวิร์กชอปศิลปะปูนปลาสเตอร์', en: 'Creative Painting Activity', zh: '创意彩绘活动', ja: 'クリエイティブ・ペインティング' },
  'act-paint-desc': { th: 'ปลดปล่อยจินตนาการไปกับกิจกรรมระบายสีตุ๊กตาปูนปลาสเตอร์รูปสัตว์น่ารัก สร้างสรรค์ผลงานศิลปะชิ้นเดียวในโลกเพื่อนำกลับไปเป็นของที่ระลึก', en: 'Unleash your imagination with our plaster painting activity! Paint cute sheep and animals. It\'s fun for the whole family, and you can take your unique masterpiece home.', zh: '通过我们的石膏彩绘活动释放您的想象力！给可爱的羊和其他动物上色。这是一项适合全家的有趣活动，您还可以将这件独一无二的杰作带回家。', ja: '石膏ペインティングで想像力を解き放ちましょう！可愛い羊や動物たちに色を塗ります。家族みんなで楽しめ、世界に一つだけの作品を持ち帰ることができます。' },
  'act-photo-title': { th: 'ถ่ายรูปเก็บความทรงจำ', en: 'Photo with Sheep', zh: '与羊合影', ja: '羊と写真撮影' },
  'act-photo-desc': { th: 'บันทึกโมเมนต์สุดประทับใจ สัมผัสความน่ารักของน้องแกะพันธุ์คอร์ริเดลที่เป็นมิตร พร้อมหามุมถ่ายรูปสวยๆ ท่ามกลางธรรมชาติอันบริสุทธิ์', en: 'Capture great memories! Touch the cuteness of our friendly, fluffy Corriedale sheep and take beautiful photos amidst a natural atmosphere.', zh: '记录美好的回忆！触摸我们友好而毛茸茸的科里代尔羊，在自然的氛围中拍下美丽的照片。', ja: '素晴らしい思い出を写真に！フレンドリーでふわふわのコリデール羊と触れ合い、大自然の中で美しい写真を撮りましょう。' },
  'act-3-title': { th: 'Stardoi Cafe & Bakery', en: 'Stardoi Cafe & Bakery', zh: '星山咖啡与烘焙', ja: 'スタードイカフェ＆ベーカリー' },
  'act-3-tag': { th: 'จุดเด่นที่ห้ามพลาด', en: 'Must Visit', zh: '不容错过', ja: '必見' },
  'act-3-p': { th: 'ผ่อนคลายในคาเฟ่เรือนไม้โอ๊คดีไซน์อบอุ่น ลิ้มรสเบเกอรี่พรีเมียมอบสดใหม่ อย่างครัวซองต์เนยฝรั่งเศสแท้จับคู่กับชาผลไม้ซิกเนเจอร์ พร้อมดื่มด่ำวิวขุนเขาผ่านกระจกใสบานใหญ่', en: 'Relax in our oak wood cafe. Enjoy freshly baked pastries like butter French croissants, signature teas, and watch sheep graze right outside the glass window.', zh: '在我们温馨的橡木咖啡馆里放松。享用每天新鲜出炉的法式黄油牛角包、特色果茶，并透过大玻璃窗观看羊群吃草。', ja: '温かみのあるオーク材のカフェでリラックス。焼きたてのフレンチバタークロワッサンや特製フルーツティーを味わいながら、大きなガラス窓越しに羊たちが草をはむ様子を眺めましょう。' },
  'act-4-title': { th: 'ฟาร์มอัจฉริยะ (Smart Farm)', en: 'Eco-Friendly Smart Farm', zh: '环保智能农场', ja: '環境に優しいスマートファーム' },
  'act-4-tag': { th: 'นวัตกรรมและธรรมชาติ', en: 'Innovation & Nature', zh: '创新与自然', ja: 'イノベーションと自然' },
  'act-4-p': { th: 'เราผสานเทคโนโลยีการจัดการฟาร์มที่ทันสมัย โดยยึดหลักความยั่งยืนและสวัสดิภาพสัตว์เป็นหัวใจสำคัญ เพื่อส่งมอบรอยยิ้มและความสุขให้กับผู้มาเยือนในทุกๆ วัน', en: 'Our farm is managed with modern smart systems, prioritizing the environment and animal welfare. All our animals are raised with love and excellent care to bring smiles to every visitor.', zh: '我们的农场采用现代智能系统管理，优先考虑环境和动物福利。我们所有的动物都在充满爱和悉心的照料下成长，为每位游客带来微笑。', ja: '当牧場は最新のスマートシステムで管理されており、環境と動物福祉を最優先しています。すべての動物は愛情と細やかなケアを受けて育ち、訪れるすべての人に笑顔を届けます。' },
  ...
  'booking-title': { th: 'ข้อมูลการเข้าชม และจองตั๋วล่วงหน้า', en: 'Visitor Info & Ticket Estimator', zh: '游客信息与门票估算', ja: '来場者情報とチケット見積もり' },
  ...
  'info-2-desc': { th: 'ผู้ใหญ่และเด็ก: 120 บาท/ท่าน | เด็กเล็ก (ความสูงไม่เกิน 120 ซม.): เข้าชมฟรี', en: 'Adult | Child: 120 THB | Child (under 120cm): FREE', zh: '成人 | 儿童：120泰铢 | 儿童（120厘米以下）：免费', ja: '大人 | 子供：120バーツ | 子供（身長120cm以下）：無料' },
  ...
  'label-adults': { th: 'บัตรเข้าชมปกติ (120 บาท/ท่าน)', en: 'Adult | Child (120 THB/person)', zh: '成人 | 儿童 (120泰铢/人)', ja: '大人 | 子供 (120バーツ/人)' },
